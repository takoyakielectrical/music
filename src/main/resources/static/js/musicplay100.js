...
document.getElementById('egroup1').addEventListener('click', () => {
	play('./music/BPM90_Egroup/Egroup1.wav');
	if (slideshowPausedNon) {
		toggleSlideshowNon();
	}
	if (slideshowPausedRoa) {
...
document.getElementById('egroup2').addEventListener('click', () => {
	play('./music/BPM90_Egroup/Egroup2.wav');
	if (slideshowPausedNon) {
		toggleSlideshowNon();
	}
	if (slideshowPausedRoa) {
